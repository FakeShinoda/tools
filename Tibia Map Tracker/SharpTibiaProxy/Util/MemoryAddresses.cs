    ...
    public class MemoryAddresses
    {
        ...
        public MemoryAddresses(Client client)
        {
            ...
            else if (client.Version == ClientVersion.Version1041)
            {
                ...
                ClientServerStart = client.BaseAddress + 0x41C568; //0x41C568
                ClientServerEnd = client.BaseAddress + 0x41C56C; //0x41C56C
                ClientServerStep = 0x38;
                ClientServerDistanceHostname = 0x04;
                ClientServerDistanceIP = 0x20;
                ClientServerDistancePort = 0x30;
                ...
                PlayerGoX = client.BaseAddress + 0x3D6D68; //3D6D68 -- 562030
                PlayerGoY = client.BaseAddress + 0x562028;
                PlayerGoZ = client.BaseAddress + 0x562004;

                ClientBattleListStart = client.BaseAddress + 0x5B8250; //5B8250 -- original 5B8188
            }
            ...
            else if (client.Version == ClientVersion.Version1094)
            {
                ...
                ClientStatus = client.BaseAddress + 0x54D244;//?
            ...
            else if ((client.Version == ClientVersion.Version1098) || (client.Version == ClientVersion.Version1099))
            {
                ClientRsa = client.BaseAddress + 0x46BAA0; //86BAA0
                ClientServerStart = client.BaseAddress + 0x59CA88; //99CA94
                ...
                ClientMultiClient = client.BaseAddress + 0x1B1AA7; //1B1AA7

                ClientStatus = client.BaseAddress + 0x556ADC;//?
			...
			/*
			else if (client.Version == ClientVersion.Version10000)
            {
                ClientRsa = client.BaseAddress + 0x48DD30; //101000 ok
                ClientServerStart = client.BaseAddress + 0x5C8060; //#########################// 5C8060-- 5C9060 -- 5CA0B0 5CA0B0
                ClientServerEnd = client.BaseAddress + 0x5C8064; //#########################// -- 5C9064 -- 5CA0B4
                ...
                ClientSelectedCharacter = client.BaseAddress + 0x70AF78; //101000 ok
                ClientMultiClient = client.BaseAddress + 0x1CDF27; //#########################// 1CDF27 - 1CECA7 --  1D0B07
				//40001E MULTCLIENT CONSANTE
				//40000C START SERVER CONSTANT
                ClientStatus = client.BaseAddress + 0x581FB0; //101000 ok 

                PlayerGoX = client.BaseAddress + 0x581F9C; //101000 ok
                PlayerGoY = client.BaseAddress + 0x581F64; //101000 ok
                PlayerGoZ = client.BaseAddress + 0x581F34; //101000 ok

                ClientBattleListStart = client.BaseAddress + 0x76A190; //101000 ok???
            }		
			*/
			else if (client.Version == ClientVersion.Version10000)
            {
                ClientRsa = client.BaseAddress + 0x48DD30; //ok
                
				
				ClientServerStart = client.BaseAddress + 0x5C8060; //# 	 MUDA EM CADA VERSAO 	#// 		
                ClientServerEnd = client.BaseAddress + 0x5C8064;   //#   MUDA EM CADA VERSAO 	#//
                ...
                ClientBattleListStart = client.BaseAddress + 0x76A0B0; //101000 ok???
                ClientBattleListStep = 0xDC;
            }		
            else
            {
